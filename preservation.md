...
2. Zip all preservation.xml and validate in the ARCHive application, adding the collection if needed using ID and title from Planner.
...
4. Check a sample of 1-5 AIPs (depending on number of AIPs and level of difference) in more detail:
